...
async def ollama_model_if_cache(
    ...
    **kwargs,
    ...
    host = kwargs.pop("host", "http://192.168.110.5:11434")
...
async def ollama_embedding(
        texts: list[str],
        embed_model:str = "mofanke/acge_text_embedding:latest",
        base_url:str = "http://192.168.110.5:11434",
        **kwargs) -> np.ndarray:
    """
    Deprecated in favor of `embed`.
    """
    embed_text = []
    ollama_client = ollama.Client(host=base_url,**kwargs)
    for text in texts:
