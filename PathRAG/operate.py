...
async def _get_node_data(
    ...
    entities_context = list_of_list_to_csv(entites_section_list) if entites_section_list else ""
    ...
    text_units_context = list_of_list_to_csv(text_units_section_list) if text_units_section_list else ""
